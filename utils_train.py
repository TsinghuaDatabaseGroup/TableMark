...
def preprocess(data_path, info_path, task_type = 'binclass', inverse = False, cat_encoding = None, concat = True):
    T_dict = {}
    ...
    dataset, num_transform, cat_transform = make_dataset(
        data_path = data_path,
        info_path = info_path,
        T = T,
        task_type = task_type,
    ...
    if cat_encoding is None:
        ...
        if inverse:
            ...
            return X_num, X_cat, categories, d_numerical, num_inverse, cat_inverse, num_transform, cat_transform
        else:
...
def make_dataset(
    ...
    return src.transform_dataset(D, T, None, True)